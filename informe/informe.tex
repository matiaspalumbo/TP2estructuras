...
% Esto es debido a que como la estructura de árboles binarios con la que trabajamos es recursiva y al trabajar con árboles balanceados la altura de los mismos se ve limitada al logaritmo de la cantidad de nodos del árbol, y por lo tanto la recursión en este contexto no representaba dificultades mayores en cuanto al uso de memoria. \par
